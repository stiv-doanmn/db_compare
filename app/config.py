...
SEARCH_PATTERNS: list[dict] = [
    ...
    {"key": "link", "label": "Link (URL)", "desc": "http:// hoặc https://",
     "regex": r"https?://[^[:space:]]+"},
    {"key": "domain", "label": "Domain / URL", "desc": "URL có http(s):// hoặc www. + TLD thật — không dính tên model res.model.info",
     "regex": r"(?:https?://|www\.)[A-Za-z0-9-]+(\.[A-Za-z0-9-]+)*\.(jp|tokyo|osaka|nagoya|yokohama|kyoto|okinawa|ryukyu|com|net|org|edu|gov|mil|int|io|co|dev|app|vn|info|biz|xyz|me|cloud|ai|tech|online|store|site|shop)(?![A-Za-z])"},
