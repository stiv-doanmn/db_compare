...
SEARCH_PATTERNS: list[dict] = [
    ...
    {"key": "link", "label": "Link (URL)", "desc": "http:// hoặc https://",
     "regex": r"https?://[^[:space:]]+"},
    {"key": "domain", "label": "Domain", "desc": "Tên miền có TLD thật (jp/co.jp/com/vn/io…), loại đuôi file .png/.pdf",
     "regex": r"[A-Za-z0-9][A-Za-z0-9-]*(\.[A-Za-z0-9-]+)*\.(jp|tokyo|osaka|nagoya|yokohama|kyoto|okinawa|ryukyu|com|net|org|edu|gov|mil|int|io|co|dev|app|vn|info|biz|xyz|me|cloud|ai|tech|online|store|site|shop)(?![A-Za-z])"},
